...
import CardRecomandaciones from '../CardRecomandaciones';
...
function UltimosLanzamientos() {
    return (
        <LibroContainer>
            <Titulo color="#000000" size="36px" align="center">Últimos Lanzamientos</Titulo>
            ...
            <CardRecomandaciones titulo="Lidedanza en Design" subtitulo="Diseñe con Conomiento" descripcion="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." imagen={livro2} />
        </LibroContainer>
    );
}
